...
public interface ICourseTableService {
    ...
    ServerResponse<List<CourseTable>> findBy(String classroom,String className, String teacherName, Integer week);
    ...
    ServerResponse<String> adjust(Integer courseTableId, Integer classroomId, Integer week, String day, Integer number, String classroomName, Integer status);
}
